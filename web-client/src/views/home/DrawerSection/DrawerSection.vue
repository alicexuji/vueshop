  ...
  <div id="meg">
    <div class="meg_nav" @click="drawer = true">
      <div class="meg_shoppingbag">
        ...
        <p>购物车</p>
        <div><span>{{ cartgoods.length }}</span></div>
      </div>
    ...
    >
      <div class="meg_show">
        ...
        <div class="meg_content">
          <DrawerItem v-for="(goods) in cartgoods" :key="goods.id" :goods="goods" @computeShopCar="computeShopCar"/>
        </div>
        ...
        <div class="toolbar_footer">
          <div class="pro_total">
            ...
            <span>
                <strong class="total_price">{{ totalPrice / 100 }}</strong>
              </span>
          </div>
